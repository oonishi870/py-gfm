...
from .fenced_code import FencedCodeExtension as qlmFencedCodeExtension
from .hidden_hilite import HiddenHiliteExtension as qlmHiddenHiliteExtension
...
def makeExtension(*args, **kwargs):
    return QiitaLikeMarkdownExtension(*args, **kwargs)


class QiitaLikeMarkdownExtension(Extension):
    """
    ...
    def extendMarkdown(self, md, md_globals):
        ...
        qlmFencedCodeExtension().extendMarkdown(md)
        qlmHiddenHiliteExtension().extendMarkdown(md, self.config)
